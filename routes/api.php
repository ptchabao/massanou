...
Route::middleware(['auth:api', 'Is_Active', 'request.safety'])->group(function () {
    ...
    //------------------------------- Internal Orders --------------------------\\
    //--------------------------------------------------------------------------\\
    Route::resource('internal_orders', 'InternalOrderController');
    Route::post('internal_orders/delete/by_selection', 'InternalOrderController@delete_by_selection');
    Route::post('internal_orders/{id}/approve', 'InternalOrderController@approve');
    Route::post('internal_orders/{id}/reject', 'InternalOrderController@reject');
    Route::post('internal_orders/{id}/ship', 'InternalOrderController@ship');
    Route::post('internal_orders/{id}/receive', 'InternalOrderController@receive');

    //------------------------------- Inter-Warehouse Requests --------------------------\\
    //-----------------------------------------------------------------------------------\\
    Route::resource('interwarehouse_requests', 'InterwarehouseRequestController');
    Route::post('interwarehouse_requests/delete/by_selection', 'InterwarehouseRequestController@delete_by_selection');
    Route::post('interwarehouse_requests/{id}/send', 'InterwarehouseRequestController@sendRequest');
    Route::post('interwarehouse_requests/{id}/proforma', 'InterwarehouseRequestController@createProforma');
    Route::post('interwarehouse_requests/{id}/accept', 'InterwarehouseRequestController@acceptProforma');
    Route::post('interwarehouse_requests/{id}/reject', 'InterwarehouseRequestController@rejectProforma');

    Route::resource('interwarehouse_payments', 'InterwarehousePaymentController');
    Route::get('interwarehouse_payments/by_request/{id}', 'InterwarehousePaymentController@getPaymentsByRequest');

    Route::resource('interwarehouse_deliveries', 'InterwarehouseDeliveryController');
    Route::post('interwarehouse_deliveries/{id}/ship', 'InterwarehouseDeliveryController@ship');
    Route::post('interwarehouse_deliveries/{id}/receive', 'InterwarehouseDeliveryController@receive');
    Route::get('interwarehouse_deliveries/{id}/pdf', 'InterwarehouseDeliveryController@deliveryNotePdf');
...
Route::get('internal_order_pdf/{id}', 'InternalOrderController@internal_order_pdf');
