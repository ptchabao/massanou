  ...
  >
        ...
        <ul class="navigation-left">
         ...
         <li
          ...
          >
            ...
            @mouseenter="toggleSubMenu"
            class="nav-item"
            :class="{ active: selectedParentMenu == 'internal_orders' }"
            data-item="internal_orders"
            :data-submenu="true"
          >
            <a class="nav-item-hold" href="#">
              <i class="nav-icon i-Arrow-Right-in-Circle"></i>
              <span class="nav-text">Commander au magasin principal</span>
            </a>
            <div class="triangle"></div>
          </li>

           <li
            v-show="currentUserPermissions && (currentUserPermissions.includes('interwarehouse_request_view')
                      || currentUserPermissions.includes('interwarehouse_request_add')
                      || currentUserPermissions.includes('interwarehouse_request_edit')
                      || currentUserPermissions.includes('interwarehouse_request_delete')
                      || currentUserPermissions.includes('interwarehouse_payment_view')
                      || currentUserPermissions.includes('interwarehouse_payment_add')
                      || currentUserPermissions.includes('interwarehouse_payment_delete')
                      || currentUserPermissions.includes('interwarehouse_delivery_view')
                      || currentUserPermissions.includes('interwarehouse_delivery_add')
                      || currentUserPermissions.includes('interwarehouse_delivery_edit'))"
            @mouseenter="toggleSubMenu"
            class="nav-item"
            :class="{ active: selectedParentMenu == 'interwarehouse' }"
            data-item="interwarehouse"
            :data-submenu="true"
          >
            <a class="nav-item-hold" href="#">
              <i class="nav-icon i-Arrow-Right-in-Circle"></i>
              <span class="nav-text">{{$t('InterWarehouse')}}</span>
            </a>
            <div class="triangle"></div>
          </li>
          <li
    ...
    >
      ...
      >
        ...
        <ul
          class="childNav d-none"
          data-parent="internal_orders"
          :class="{ 'd-block': selectedParentMenu == 'internal_orders' }"
        >
          <li
            class="nav-item"
            v-if="currentUserPermissions && currentUserPermissions.includes('internal_order_add')"
          >
            <router-link tag="a" class to="/app/internal_orders/store">
              <i class="nav-icon i-Add-File"></i>
          ...
          <li
            class="nav-item"
            v-if="currentUserPermissions && currentUserPermissions.includes('internal_order_view')"
          >
            <router-link tag="a" class to="/app/internal_orders/list">
              <i class="nav-icon i-Files"></i>
        ...
        <ul
          class="childNav d-none"
          data-parent="interwarehouse"
          :class="{ 'd-block': selectedParentMenu == 'interwarehouse' }"
        >
          <li
            class="nav-item"
            v-if="currentUserPermissions && currentUserPermissions.includes('interwarehouse_request_add')"
          >
            <router-link tag="a" class to="/app/interwarehouse/create">
              <i class="nav-icon i-Add-File"></i>
              <span class="item-name">{{$t('CreateRequest')}}</span>
            </router-link>
          </li>
          <li
            class="nav-item"
            v-if="currentUserPermissions && currentUserPermissions.includes('interwarehouse_request_view')"
          >
            <router-link tag="a" class to="/app/interwarehouse/list">
              <i class="nav-icon i-Files"></i>
              <span class="item-name">{{$t('ListRequests')}}</span>
            </router-link>
          </li>
           <li
            class="nav-item"
            v-if="currentUserPermissions && currentUserPermissions.includes('interwarehouse_delivery_view')"
          >
            <router-link tag="a" class to="/app/interwarehouse/deliveries">
              <i class="nav-icon i-Truck"></i>
              <span class="item-name">{{$t('Deliveries')}}</span>
            </router-link>
          </li>
        </ul>
