                  ...
                  <b-card no-body class="ul-card__border-radius">
                    <b-card-header header-tag="header" class="p-1" role="tab">
                      <b-button
                        ...
                        block
                        href="#"
                        v-b-toggle.panel-InternalOrders
                        variant="transparent"
                      >Internal Orders</b-button>
                    </b-card-header>
                    <b-collapse
                      id="panel-InternalOrders"
                      :visible="true"
                      accordion="my-accordion-internal-orders"
                      role="tabpanel"
                    >
                      <b-card-body>
                        <b-card-text>
                            ...
                            <b-col md="6">
                              <label class="checkbox checkbox-outline-primary">
                                <input
                                  ...
                                  checked
                                  v-model="permissions"
                                  value="internal_order_add"
                                >
                                <span>{{$t('Add')}}</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                            <!--Internal Orders Edit -->
                            <b-col md="6">
                              <label class="checkbox checkbox-outline-primary">
                                <input
                                  type="checkbox"
                                  checked
                                  v-model="permissions"
                                  value="internal_order_edit"
                                >
                                <span>{{$t('Edit')}}</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                            <!--Internal Orders Delete -->
                            <b-col md="6">
                              <label class="checkbox checkbox-outline-primary">
                                <input
                                  type="checkbox"
                                  checked
                                  v-model="permissions"
                                  value="internal_order_delete"
                                >
                                <span>{{$t('Del')}}</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                            <!--Internal Orders Approve -->
                            <b-col md="6">
                              <label class="checkbox checkbox-outline-primary">
                                <input
                                  type="checkbox"
                            ...
                            <b-col md="6">
                              <label class="checkbox checkbox-outline-primary">
                                <input
                                  ...
                                  checked
                                  v-model="permissions"
                                  value="internal_order_ship"
                                >
                                <span>Ship</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                            <!--Internal Orders Receive -->
                            <b-col md="6">
                              <label class="checkbox checkbox-outline-primary">
                                <input
                                  type="checkbox"
