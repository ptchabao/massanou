        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="d-flex justify-content-between align-items-center mt-2">
              ...
              <div>
                <span class="mr-3">{{ $t('Total_Debit') }}: <strong>{{ totals.debit.toFixed(2) }}</strong></span>
                <span>{{ $t('Total_Credit') }}: <strong>{{ totals.credit.toFixed(2) }}</strong></span>
...
export default {
  ...
  methods: {
    ...
    toMoney(v) { const n = parseFloat(v || 0); return n.toLocaleString(undefined,{minimumFractionDigits:2, maximumFractionDigits:2}); },
