<template>
  <div class="main-content">
    <breadcumb :page="$t('Create_InternalOrder')" :folder="$t('ListInternalOrders')"/>
    <div v-if="isLoading" class="loading_page spinner spinner-primary mr-3"></div>

    <validation-observer ref="Create_InternalOrder" v-if="!isLoading">
...
export default {
  ...
  methods: {
    ...
    //------------- Submit Validation Create Internal Order
    Submit_InternalOrder() {
      this.$refs.Create_InternalOrder.validate().then(success => {
        if (!success) {
          this.makeToast(
            "danger",
    ...
    Create_InternalOrder() {
      ...
      axios
        ...
        .then(response => {
          ...
          this.makeToast(
            "success",
            this.$t("Create.TitleInternalOrder"),
            this.$t("Success")
          );
    ...
    GetElements() {
      ...
      axios
        ...
        .catch(error => {
          ...
          this.makeToast(
            "danger",
            "Erreur de chargement des entrepôts",
            "Erreur"
          );
          setTimeout(() => {
            this.isLoading = false;
