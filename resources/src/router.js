...
const baseRoutes = [
    {
        ...
        children: [
            ...
            //Internal Orders
            {
                path: "/app/internal_orders",
                component: () =>
                    import(
                        /* webpackChunkName: "internal_orders" */ "./views/app/pages/internal_orders"
                    ),
                redirect: "/app/internal_orders/list",
                children: [
                    {
                        name: "index_internal_order",
                        path: "list",
                        component: () =>
                            import(
                                /* webpackChunkName: "index_internal_order" */ "./views/app/pages/internal_orders/index_internal_order"
                            )
                    },
                    {
                        name: "store_internal_order",
                        path: "store",
                        component: () =>
                            import(
                                /* webpackChunkName: "store_internal_order" */
                                "./views/app/pages/internal_orders/create_internal_order"
                            )
                    },
                    {
                        name: "edit_internal_order",
                        path: "edit/:id",
                        component: () =>
                            import(
                                /* webpackChunkName: "edit_internal_order" */ "./views/app/pages/internal_orders/edit_internal_order"
                            )
                    }
                ]
            },
            ...
            // Inter-Warehouse
            {
                path: "/app/interwarehouse",
                component: () =>
                    import(
                        /* webpackChunkName: "interwarehouse" */ "./views/app/pages/interwarehouse"
                    ),
                redirect: "/app/interwarehouse/list",
                children: [
                    {
                        name: "index_interwarehouse",
                        path: "list",
                        component: () =>
                            import(
                                /* webpackChunkName: "index_interwarehouse" */ "./views/app/pages/interwarehouse/index_interwarehouse"
                            )
                    },
                    {
                        name: "create_interwarehouse",
                        path: "create",
                        component: () =>
                            import(
                                /* webpackChunkName: "create_interwarehouse" */ "./views/app/pages/interwarehouse/create_interwarehouse"
                            )
                    },
                    {
                        name: "edit_interwarehouse",
                        path: "edit/:id",
                        component: () =>
                            import(
                                /* webpackChunkName: "edit_interwarehouse" */ "./views/app/pages/interwarehouse/edit_interwarehouse"
                            )
                    },
                    {
                        ...
                        component: () =>
                            import(
                                /* webpackChunkName: "create_proforma" */ "./views/app/pages/interwarehouse/create_proforma"
                            )
                    },
                    {
                        name: "payments_interwarehouse",
                        path: "payments/:id",
                        component: () =>
                            import(
                                /* webpackChunkName: "payments_interwarehouse" */ "./views/app/pages/interwarehouse/payments_interwarehouse"
                            )
                    },
                    {
                        name: "deliveries_interwarehouse",
                        path: "deliveries",
                        component: () =>
                            import(
                                /* webpackChunkName: "deliveries_interwarehouse" */ "./views/app/pages/interwarehouse/deliveries_interwarehouse"
                            )
                    }
                ]
            },
